function OptimalPath=ASTARPATH_improved(StartX,StartY,MAP,GoalRegister,Connecting_Distance,value_B)
%Version 1.0
    ...
    for p=1:N_Neighboors
        ...
        if(ClosedMAT(CurrentY+i,CurrentX+j)==0) %Neiboor is open;
            ...
            if Flag==1;           
                ...
                FScore(CurrentY+i,CurrentX+j)= tentative_gScore+value_B*Hn(CurrentY+i,CurrentX+j);
            end
        end
    end
end
